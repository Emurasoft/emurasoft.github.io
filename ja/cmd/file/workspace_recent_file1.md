...
このコマンドは通常、複数のメニュー項目から成り立っています。最近使ったワークスペース ファイルに対して実行できます。このコマンドを実行すると、指定したワークスペース ファイルを開きます。最近のワークスペースとして表示するメニュー項目の数は、 [\[カスタマイズ\] ダイアログ ボックス](../../dlg/customize/index) の [\[履歴\] ページ](../../dlg/customize/history/index) の
