...
ステータス バーに表示されている文字列をUnicodeで取得します。このインライン関数を使うか、または
[EE\_GET\_STATUSW](../message/ee_get_statusw) メッセージを直接送ることができます。

Editor\_GetStatusW( HWND hwnd, LPWSTR szStatus, UINT\_PTR nBufSize );
