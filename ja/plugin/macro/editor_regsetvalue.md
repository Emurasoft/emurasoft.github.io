...
EmEditor の設定に応じて、レジストリまたは INI ファイルに、値を設定します。このインライン関数を使うか、または
[EE\_REG\_SET\_VALUE メッセージ](../message/ee_reg_set_value) を直接送ることができます。
...
成功すると ERROR\_SUCCESS を返します。失敗すると Winerror.h で定義された 0 でないエラー コードになります。
