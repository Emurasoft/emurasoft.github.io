...
|     |     |
| --- | --- |
| [Delete](../selection/selectiondelete) | 選択範囲を削除します。選択が空の場合は、右側の指定した文字数だけ削除します。Delete キーに相当。 |
| [DeleteLeft](../selection/selectiondeleteleft) | 選択範囲を削除します。選択が空の場合は、左側の指定した文字数だけ削除します。Backspace キーに相当。 |
