...
| ![](../../images/windowalwaystop.png)[常に手前に表示](../../cmd/window/window_always_top) | このウィンドウを常に手前に表示または解除します。 |
...
| ![](../../images/sortinga-z.png)[AからZへ並べ替え](../../cmd/sort/sort_text_a) | 現在の列のテキストを昇順で並べ替えます。 |
