...
- [사용자 지정 대화 상자](../dlg/customize/index) 의 [창 탭](../dlg/customize/window/index) 에닫기 명령을 선택하여 마지막 문서를 닫지 않음 체크 박스가 추가되었습니다.
- [외부 도구 속성 대화 상자](../dlg/tools/properties/index) 에출력 모음 사용 체크 박스가 추가되었습니다.
- [세부 정보 저장 대화 상자](../dlg/properties/file/save_details/index) 에제목없음 문서 자동 이름 지정 체크 박스가 추가되었습니다.
- 현재 폴더를 위한 관리 방법이 바뀌었습니다. 이것은 이전에 사용된 폴더들이 삭제되는 문제를 해결했습니다.
- [사용자 지정 대화 상자](../dlg/customize/index) 의 [탭 탭](../dlg/customize/tab/index) 에탭의 외부 \- 가운데 마우스 버튼 클릭 드롭 다운 리스트 박스와탭의 외부 \- 왼쪽 마우스 버튼 더블 클릭 드롭 다운 리스트 박스가 추가되었습니다.
...
- [찾기 대화 상자](../dlg/find/index) 에모든 열린 문서 검색 체크 박스가 추가되었습니다.
- 이제부터 매크로의 첫 줄에 [#language 지침서](../macro/directive/language) 를 추가하여 JavaScript 와 VBScript가 아닌 ActiveScript 언어를 사용 할 수 있습니다.
- [사용자 지정 대화 상자](../dlg/customize/index) 의 [파일 탭](../dlg/customize/file/index) 에프린터 엑세스 피하기 체크 박스가 추가되었습니다.
- [사용자 지정 대화 상자](../dlg/customize/index) 의 상태 탭에현재 폴더 체크 박스가 추가되었습니다.
