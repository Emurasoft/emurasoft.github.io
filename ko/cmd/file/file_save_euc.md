# Japanese EUC으로 저장 명령

### 요약

> Japanese EUC 인코딩을 사용하여 현재 파일을 저장합니다.

### 설명

> 이 명령은 문서의 제목이 정해져 있지 않는 한, 현재의 파일 이름으로 Japanese EUC 인코딩을 사용하여 문서를 저장합니다.
