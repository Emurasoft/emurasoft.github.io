...
이 명령은 여러 메뉴 항목을 포함하고 있으며, 현재 커서 위치에 최근 파일 중 선택된 파일을 삽입합니다.도구 메뉴 아래 [사용자 지정 대화 상자](../../dlg/customize/index) 의 [기록 탭](../../dlg/customize/history/index) 의최근 파일 수 텍스트 박스에서 최근 파일로 나타낼 파일의 수를 설정 할 수 있습니다.(도구 \>사용자 지정 \>기록)
