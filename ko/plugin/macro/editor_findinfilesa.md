...
지정된 경로 내에 여러 파일로부터 ANSI 문자열을 검색합니다. 현재 창에 검색된 파일의 목록이 나타납니다. 현재 문서가 수정된 경우,
현재 파일의 변경을 저장할 지 여부를 묻는 확인 메시지 박스가 나타납니다. 이 인라인 함수를 사용하거나
[EE\_FIND\_IN\_FILESA](../message/ee_find_in_filesa) 메시지를 명시적으로 보낼 수 있습니다.
