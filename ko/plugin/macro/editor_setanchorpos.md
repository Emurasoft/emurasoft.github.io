...
선택 영역의 원점을 설정합니다. 이 인라인 함수를 사용하거나 [EE\_SET\_ANCHOR\_POS](../message/ee_set_anchor_pos) 메시지를 명시적으로 보낼 수 있습니다.
...
> 선택 영역의 원점을 지정하는 [POINT\_PTR 구조](../structure/point_ptr) 에 대한
> 포인터입니다.
