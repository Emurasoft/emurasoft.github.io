...
[EE\_REG\_SET\_VALUE 메시지](../message/ee_reg_set_value) 에 의해 사용됩니다.
...
> 바이트로 나타낸 데이터 구조의 크기입니다. 이 멤버를 sizeof( REG\_SET\_VALUE\_INFO )로 설정합니다.
...
> | EEREG\_EMEDITORPLUGIN | HKEY\_CURRENT\_USER\\Software\\EmSoft\\EmEditorPlugIns\\(pszConfig) 또는 eePlugin.ini\\\[(pszConfig)\] |
