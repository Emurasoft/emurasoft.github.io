...
사용 가능한 구성들을 열거합니다. 이 메시지를 명시적으로 보내거나
[Editor\_EnumConfig](../macro/editor_enumconfig) 인라인 함수를 사용할 수 있습니다.
...
> 두개의 NULL문자는 구성 목록의 마지막에 추가될 것입니다. 0이 지정되면, pBuf은 NULL이 될수 있습니다.

## 반환 값

> 반환 값은 구성 목록을 검색하기에 필요한 크기입니다.
