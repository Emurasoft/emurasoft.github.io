...
혹은도구 메뉴에서플러그인 을 가리킨 다음,코드조각 을 클릭해 주십시오.
...
-F6 키 혹은ESC 키를 편집기로 다시 초점을 맞추기 위해 눌러주십시오.
- 사용자 지정 바 위치는플러그인 바에서플러그인 버튼 을 오른쪽 클릭하고 난 후,속성 을 선택해서 상위, 하위, 오른쪽, 혹은 왼쪽에 설정될 수 있습니다.
