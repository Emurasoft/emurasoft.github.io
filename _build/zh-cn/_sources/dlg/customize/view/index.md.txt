...
如果选择了 **系统**，EmEditor 会用 Windows 10 中指定的模式，比如如果您在 Windows 10 中选择了暗模式时，EmEditor 也会沿用暗模式。如果选择了亮模式，EmEditor 会沿用亮模式。编辑器颜色可以在配置属性的 [**显示** 页面](../../properties/display/index) 上设定。
