...
| [Editor\_FindInFiles](editor_findinfiles) | Searches for a string from multiple files in the specified path. |
...
| [Editor\_SetStatusA](editor_setstatusa) | Displays an ANSI message on the status bar. |
