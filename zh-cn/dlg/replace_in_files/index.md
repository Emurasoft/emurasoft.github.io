...
如果勾选了该复选框，EmEditor 将会在备份文件夹 文本框中指定的文件夹中创建原始文件的备份。如果在子文件夹中查找 复选框被勾选了，原始的文件夹目录树将会在备份文件夹中保留。
...
如果保存备份 复选框被勾选了，会在备份文件夹中复制原始文件的备份。
...
在在文件中替换 对话框与批处理在文件中替换 对话框之间切换。

下列控件仅在该对话框扩展为批处理在文件中替换 对话框时显示。
