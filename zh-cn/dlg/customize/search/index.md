...
指定要在 EmEditor 中使用的正则表达式引擎。你能选择 **Boost.Regex**，**Onigmo.Ruby**，或 **Onigmo.Perl**。正则表达式用在 **查找**， **替换**， **在文件中查找**， **在文件中替换**， **筛选**， **高亮**， **标记跳转**， **自动缩进**， **大纲**，以及插件中。这个选项的设定会影响到在 EmEditor 中所有的正则表达搜索。但是，当用于 **查找**， **替换**， **在文件中查找**，以及 **在文件中替换** 命令时，正则表达式引擎能在这些命令的 [**高级** 对话框](../../advanced/index) 中另外设定。
