...
将编码相关的选项（编码 下拉列表框，以及全部检测，检测 HTML/XML 字符集，和检测 UTF-8 复选框）保存为默认值，以便下次打开此对话框时还原这些选项。
...
在在文件中查找 对话框与批处理在文件中查找 对话框之间切换。

下列控件仅在该对话框扩展为批处理在文件中查找 对话框时显示。
