...
5\. 当您点击下载链接后，会出现一个 **文件下载-安全警告** 对话框:

![File Download - Security Warning](../../images/emeditor_file_download.png)

6\. 请点击 **“运行”**，然后会弹出一个 **网络浏览器-安全警告** 对话框:

![Internet Explorer - Security Warning](../../images/emeditor_file_security.png)

7\. 选择 **发布商: Emurasoft, Inc.**

![Digital Signature Details](../../images/signature_details.png)

8\. 请确保在 **电子签名细节** 对话框中有 **“电子签名可用”** 这个信息。如果这个信息没有在对话框中显示，那么下载的文件可能被损坏了。这样您就需要先清除临时的网络文件 (Temporary Internet files)，再尝试下载一次。点击“确定”关闭对话框。
