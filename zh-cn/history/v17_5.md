...
- 将EI\_REFRESH\_COMMON\_SETTINGS 命令添加到 [EE\_INFO 消息](../plugin/message/ee_info) 中。

## 新增宏功能

- 将[AutoFill](../macro/document/autofill) 方法添加到Document 对象。
- 将 [RefreshCommonSettings 方法](../macro/editor/refresh_common_settings) 添加到Editor 对象。
