...
-标签外 \- 单击鼠标中键 下拉列表框还有标签外 \- 双击鼠标左键 下拉列表框被添加到了 [自定义 对话框](../dlg/customize/index) 中的 [标签 页面](../dlg/customize/tab/index) 上。
...
- The当前文件夹 复选框被添加到了 [自定义 对话框](../dlg/customize/index) 中的状态栏页面上。
