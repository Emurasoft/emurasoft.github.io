...
| ![](../images/html2uni24x16.gif)[将 HTML/XML 字符引用转换为 Unicode](../cmd/convert/decode_html_char_ref) | 将选中的文本视为 HTML/XML 字符引用进行解码。 |
| ![](../images/uni2html24x16.gif)[将 Unicode 转换为 HTML/XML 字符引用](../cmd/convert/encode_html_char_ref) | 将已选中的文本编码为 HTML/XML 字符引用的格式。 |
| ![](../images/ucs2uni24x16.gif)[将通用字符名称转换为 Unicode](../cmd/convert/decode_ucn) | 将选中的文本视为通用字符名称进行解码。 |
| ![](../images/uni2ucs24x16.gif)[将 Unicode 转换为通用字符名称](../cmd/convert/encode_ucn) | 将选中的文本编码为通用字符名称。 |
