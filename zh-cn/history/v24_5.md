...
- 新版本为AI辅助编辑功能提供了更大的灵活性。现在，您可以选择仅在按下 `Ctrl+Space` 时显示建议。此外，您可以设置置信水平，并仅在 AI 的置信度达到某个阈值时显示建议。您还可以选择调整输入文本（用于预测）和输出文本（用于候选建议）的长度。{{pro}}
...
- [AI 辅助属性](../cmd/tools/property_ai_assist) {{pro}}
