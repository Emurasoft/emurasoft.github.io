...
|  | v23.0 | v23.1 | 比较 |
| --- | --- | --- | --- |
| 打开文件 \[\*A\] | 0.276 秒 | 0.117 秒 | times faster |
| 替换全部 \[\*B\] | 0.351 秒 | 0.120 秒 | times faster |
| 剪切并粘贴 \[\*C\] | 4680 秒 | 2370 秒 | times faster |
| 大小写转换 \[\*D\] | 523 秒 | 172 秒 | times faster |
| 转换 CSV 格式 \[\*E\] | 1310 秒 | 594 秒 | times faster |
| 自动填充 \[\*F\] | 1290 秒 | 32.7 秒 | times faster |
| 合并行 \[\*G\] | 566 秒 | 252 秒 | times faster |
| 插入列 \[\*H\] | 152 秒 | 99.0 秒 | times faster |
| 设置列 \[\*I\] | 137 秒 | 93.8 秒 | times faster |
| 排序 CSV \[\*J\] | 373 秒 | 239 秒 | times faster |
| 差分列 \[\*K\] | 536 秒 | 317 秒 | times faster |
