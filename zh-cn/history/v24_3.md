...
- [AI 提示（多个项目）](../cmd/tools/ai_item1) {{pro}}
- [AI 工具栏](../cmd/view/show_ai_bar) {{pro}}
- [与 AI 聊天](../cmd/view/view_chat_ai) {{pro}}
- [自定义 AI 提示](../cmd/tools/customize_ai_list) {{pro}}
- [自定义与 AI 聊天](../cmd/tools/customize_chat_ai) {{pro}}
