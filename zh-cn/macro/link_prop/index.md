...
| [MailTo](mail_to) | 与配置属性中 [**链接** 页面](../../dlg/properties/link/index) 上的 **点击邮件地址时发送邮件** 复选框相对应。 |
| [OpenFileInQuotes](open_file_in_quotes) | 与配置属性中 [**链接** 页面](../../dlg/properties/link/index) 上的 **点击引号内的文件名打开文件** 复选框相对应。 |
| [SelectInQuotes](select_in_quotes) | 与配置属性中 [**链接** 页面](../../dlg/properties/link/index) 上的 **点击引号内的文本选择整个字符串** 复选框相对应。 |
| [URL](url) | 与配置属性中 [**链接** 页面](../../dlg/properties/link/index) 上的 **链接到 URL** 复选框相对应。 |
