...
要在一个消息框中显示简单的文本，你能用 [alert 方法](../window/window_alert) 或 [confirm 方法](../window/window_confirm)。然而，这些方法仅能显示三个按钮: YES，NO 以及 CANCEL。要在消息框中显示更多复杂的文本，请用 WshShell 对象的 Popup 方法。
