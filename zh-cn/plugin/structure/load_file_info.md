...
| LFI\_USE\_TEMP\_FILE | 打开文件时使用临时文件。 |
| LFI\_DONT\_USE\_TEMP\_FILE | 打开文件时不使用临时文件。如果既没有指定 LFI\_USE\_TEMP\_FILE 也没有指定 LFI\_DONT\_USE\_TEMP\_FILE，EmEditor 会根据将要打开的文件大小自动选择使用临时文件。 |
