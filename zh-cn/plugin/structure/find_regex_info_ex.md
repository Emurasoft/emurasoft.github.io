...
| FLAG\_FIND\_FUZZY | 此特殊标志使用模糊匹配，并禁用正则表达式。您不能将模糊匹配与正则表达式结合使用。即不能与 FLAG\_FIND\_REGEX\_BOOST，FLAG\_FIND\_REGEX\_ONIGMO，FLAG\_FIND\_REGEX\_ONIGMO\_PERL，或 FLAG\_FIND\_SEPARATE\_CRLF 合用。 |
