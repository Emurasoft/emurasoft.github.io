...
- 点击 **+ 文件** 上传文件。
  ...
  - 你也可以点击**浏览**，通过文件浏览对话框选择受支持的文件。  
  - 上传文件后，“与 AI 聊天”会同时创建文件资源和向量存储资源。之后即可在聊天对话中引用该文件。
  - 已上传的文件会显示在输入区域中。点击文件可将其移除，或右键单击查看更多选项。
  - 引用已上传的文件通常比直接将文件内容复制粘贴到聊天中消耗更少的 token。
- 启用**工具**以使用工具调用功能。这些 EmEditor 工具可供 AI 用于读取或修改你的文档。
  - 将鼠标悬停在**工具**上并选择**设置**，以查看并配置可用工具。
  - 使用工具会产生额外的 token 费用。
