...
1. 在插件 栏上点击![](../../images/projects.gif) 。或在工具 菜单下，指向插件，然后点击项目， 便会出现项目 自定义分栏。
2. 右击项目 栏，选择新建项目。
3. 右击无标题项目，把鼠标指针移到“项目”上，然后点击“添加现有的文件”。
4. 选择所有你想要包含在项目中的文件。
...
|![](../../images/solutiontemplates.gif) 解决方案模板 | 显示解决方案模板 对话框。 |
...
|     |     |
| --- | --- |
|解决方案格式 | 选择一个解决方案格式。目前，只有EmEditor 以及Visual Studio 可以选取。 |
...
- 按ESC 键能让键盘焦点回到编辑器中。
- 你可以在无标题项目 上右击，选择项目另存为 来保存无标题项目。
