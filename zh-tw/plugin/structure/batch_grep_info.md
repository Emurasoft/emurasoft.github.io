...
[Editor\_BatchReplaceInFiles](../macro/editor_batchreplaceinfiles) 內嵌函式 ( [EE\_FIND\_IN\_FILESW](../message/ee_find_in_filesw) 和 [EE\_REPLACE\_IN\_FILESW 消息](../message/ee_replace_in_filesw)) 。
