...
- 用 **WebView2** 控件在 EmEditor 中添加了顯示嵌入式**網頁瀏覽器**的功能。 可以在**自訂**對話方塊的新**網頁瀏覽器**頁面中設定初始主頁的 URL。**網頁瀏覽器**設計為與巨集結合使用。編寫巨集使您能夠將特定文字發送到網站。**onLoad** 事件使您能夠在加載網頁時檢索特定文字。另外，您還可以在**自訂**對話方塊的新**網頁瀏覽器**頁面中自訂初始首頁 URL。 {{pro}}
