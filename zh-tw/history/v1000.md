...
| ![](../images/html2uni24x16.gif)[將 HTML/XML 字符引用轉換為 Unicode](../cmd/convert/decode_html_char_ref) | 將選中的文本視為 HTML/XML 字符引用進行解碼。 |
| ![](../images/uni2html24x16.gif)[將 Unicode 轉換為 HTML/XML 字符引用](../cmd/convert/encode_html_char_ref) | 將已選中的文本編碼為 HTML/XML 字符引用的格式。 |
| ![](../images/ucs2uni24x16.gif)[將通用字符名稱轉換為 Unicode](../cmd/convert/decode_ucn) | 將選中的文本視為通用字符名稱進行解碼。 |
| ![](../images/uni2ucs24x16.gif)[將 Unicode 轉換為通用字符名稱](../cmd/convert/encode_ucn) | 將選中的文本編碼為通用字符名稱。 |
