...
- 在自訂 對話方塊的 [「格式」 頁](../dlg/customize/format/index) 上添加了「空格寬度」 滑桿。
- 在組態屬性 對話方塊的 [「捲動」 頁](../dlg/properties/scroll/index) 上添加了「3D 外觀」 核取方塊。
...
- 添加了 [SetCell](../macro/document/setcell)， [SetColumn](../macro/document/setcolumn)，和 [InsertColumn](../macro/document/insertcolumn) 方法到Document 對象中。
