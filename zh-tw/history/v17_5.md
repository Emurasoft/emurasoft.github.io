...
- 將EI\_REFRESH\_COMMON\_SETTINGS 命令添加到 [EE\_INFO 消息](../plugin/message/ee_info) 中。

## 新增巨集功能

- 將[AutoFill](../macro/document/autofill) 方法添加到Document 對象。
- 將 [RefreshCommonSettings 方法](../macro/editor/refresh_common_settings) 添加到Editor 對象。
