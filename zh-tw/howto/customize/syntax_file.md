...
| #SpecialSyntax= | 指定 **HTML**， **HTML-內嵌**，或 **無**，取決于在同一個文檔中是否有 HTML 和其他指令碼語言的混合。<br>- 選擇 **HTML**，當 HTML 標籤指定指令碼語言 (**\<SCRIPT type=...\>**) 存在在這個 **HTML** 文檔中。   HTML 同樣也適用於包含以 <% 標記開始的指令碼的 ASP 檔案，諸如 VBScript，JavaScript，PerlScript，CSS，等。<br>- **HTML-內嵌** 適用於 PHP 或 JSP 這樣的指令碼語言，并且通常這些指令碼語言以 #ScriptBegin 字元開始。 |
