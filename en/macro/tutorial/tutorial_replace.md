...
The first argument of the [Replace Method](../selection/selectionreplace)
...
selected by selecting the [Run with Temporary Options command](../../cmd/macros/macrorunoptions) under the Macro menu
