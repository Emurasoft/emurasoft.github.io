...
It provides methods and properties of Windows user interfaces. The[document Property](../window/window_document) allows you to use properties and methods of [Document Object](../document/index)
for the current document. Also, the[editor Property](../window/window_editor) allows you to access [Editor Object](../editor/index).
...
the setup name, and the read-only status. Furthermore, the[selection Property](../document/document_selection) allows you to use[Selection Object](../selection/index) for the current Selection Range and cursor location.
