...
| [ShowReturns](show_returns) | Corresponds to the **Show**<br>**Returns** check box in the <br> [**Marks** tab o](../../dlg/properties/marks/index) f Configuration Properties. |
...
| [ShowTabs](show_tabs) | Corresponds to the **Show Tabs** check box in the <br> [**Marks** tab](../../dlg/properties/marks/index) of Configuration Properties. |
| [ShowUserDefinedGuides](show_user_defined_guides) | Corresponds to the **Show User-Defined Guides** check box in the <br> [**Marks** tab](../../dlg/properties/marks/index) of Configuration Properties. |
