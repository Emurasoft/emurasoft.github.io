...
> This command saves the document after converting all newline characters into CR only
> (Macintosh). If the document is untitled, the **Save As** dialog box appears,
