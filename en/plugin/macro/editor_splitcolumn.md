...
Splits specified columns of the current CSV document. You can use this inline function or explicitly send the [EE\_SPLIT\_COLUMN](../message/ee_split_column) message.
