...
Sorts the document. You can use this inline function or explicitly send
the [EE\_SORT](../message/ee_sort) message.
...
Specifies an array of [COLUMN\_INFO structures](../structure/column_info) each of which contains the column to be sorted and the flag to be used. This field cannot be NULL.
