...
Retrieves the ending character position of the selection. You can use this inline function or explicitly send the [EE\_GET\_SEL\_END](../message/ee_get_sel_end) message.
