...
| [EE\_GET\_COLOR](ee_get_color) | Retrieves the text and background colors and style for the specified part. |
...
| [EE\_SET\_MODIFIED](ee_set_modified) | Changes the modified state of the text. |
