...
> | LFI\_USE\_TEMP\_FILE | Uses temporary files when opening a file. |
> | LFI\_DONT\_USE\_TEMP\_FILE | Doesn't use temporary files when opening a file. If neither LFI\_USE\_TEMP\_FILE nor LFI\_DONT\_USE\_TEMP\_FILE is specified, EmEditor automatically selects to use temporary files depending on the size of the file that is about to be opened. |
