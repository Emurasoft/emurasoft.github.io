...
Specifies the size of this structure, sizeof( COMPARE\_INFO ).
...
If COMPARE\_GENERATE\_REPORT is specified in the flags field, EmEditor saves a comparison report as the specified file name.
