...
- TheSwitch to last used document for Next Document check box was added in the [Window \
page](../dlg/customize/window/index) of the
[Customize dialog box](../dlg/customize/index).
- TheStrip Path for Files in Current Folder check box and
theExtra Keyboard Shortcut drop-down list box
were
...
- TheMonitor Interval text box was added to the [File \
page](../dlg/properties/file/index) of the[Configuration Properties](../dlg/properties/index).
- TheCopy button was added to the [External Tools dialog box](../dlg/tools/index).
