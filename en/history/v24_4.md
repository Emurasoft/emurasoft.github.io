...
- You can now access hidden menus on the Main manu using keyboard shortcuts when the window width is reduced. For instance, you can still open the "Macros" menu with Alt+M, even if the window is small.
