...
- The **Exclude Matched and Same-Length Word from the Candidate List** check box was added to the **Options** tab of the [plug-in properties](../howto/plugin/plugin_wordcomplete).
...
( **Search** tab of the **Customize** dialog box) were deprecated.
