...
- Added the **Verify files immediately after opening** and **Display verification results only if there is a failure** check boxes to the **File** page of the **Customize** dialog box. {{pro}}
- Added the [**Proxy** page](../dlg/customize/proxy/index) to the **Customize** dialog box. {{pro}}
- Added **Proxy Settings** hyperlink to the **Register Product** dialog box. {{pro}}
