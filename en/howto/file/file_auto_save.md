...
Toolbar to display theAuto Save tab.
2. CheckAuto Save, and specify how often you want to automatically
save open files.
...
check theRename if the Same File Name Exists option.
