...
This dialog box appears when the **New** button is selected in the [**Define Configurations** dialog box](../index). You can select a template to create a new configuration.
