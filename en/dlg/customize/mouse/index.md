...
## Use mouse wheel to select checkbox
...
## Enable text drag and drop checkbox
...
## CTRL+click to select a word checkbox
...
## Middle-click to paste checkbox
...
## Enable AutoRepeat handle in non-cell selection mode checkbox

If this box is checked, you can use the AutoRepeat handle in non-Cell Selection Mode.

## Activate EmEditor when text is dropped from another app checkbox

If this box is checked, the EmEditor window will be activated when text is dropped from another app.

## Click the left edge of a line number to toggle the bookmark checkbox
