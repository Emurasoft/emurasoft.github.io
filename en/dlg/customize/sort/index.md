...
## Treat punctuation marks the same as symbols checkbox
...
## Treat digits as numbers checkbox
...
## Ignore leading non-numeric characters when sorting numbers/IP addresses checkbox
...
## Treat full-width characters as two characters when sorting by length checkbox
...
## Compare unquoted strings in cells of CSV documents checkbox
...
## Inspect only selected strings when a vertical selection or multiple selections exist checkbox

Inspects only selected strings for sort when vertical selection or multiple selections exist.

## Group identical strings when sorting by occurrence checkbox

Groups identical strings when sort by occurrence.

## Allow digit grouping checkbox
