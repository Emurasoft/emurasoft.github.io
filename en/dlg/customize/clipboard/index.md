...
## Show Clipboard History on Paste checkbox
...
## Monitor the Clipboard copied on external applications checkbox

If this is checked, EmEditor will monitor the Clipboard contents copied on external applications.

## Retrieve Windows Clipboard History on startup checkbox
...
## Move recently used string to the top in Clipboard history checkbox
