...
## Read only in headings checkbox

Specifies whether headings should be read only.

## Adjust separator positions automatically checkbox
...
## Adjust separator positions in visual lines only checkbox
...
## Enable drag and drop to move or copy cells in cell selection mode checkbox
...
## Press TAB to create a new cell in cell selection mode checkbox
