...
## Hide matched strings/replace with regular expressions checkbox

Specifies whether matched strings should be hidden in the custom bar. If the **Regular Expression** checkbox is checked, this option specifies whether matched strings should be replaced with strings specified at the **Replace with**.
...
Specifies a string to replace with when the **Hide matched strings/replace with regular expressions** checkbox is checked.
