...
(Select
the **Tab/Indent** button on the [**General** page](general/index))

(Select the **New Files** button on the
[**File** page](file/index))

(Select the **Saving** button on the [**File** page](file/index))

(Select the **Font** button on the
[**Display** page](display/index) or [**Print** page](print/index))

(Select the **Add** button on the [**Character Check** page](char_check/index))
