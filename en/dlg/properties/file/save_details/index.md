...
This dialog box appears when the **Saving** button on the [**File** page](../index) of Configuration Properties is selected.
...
Enables the [**Save** command](../../../../cmd/file/file_save) even if the document is not modified.
