...
This dialog box appears when the [**New Files** button](../index) on the [**File** page](../index) of Configuration Properties is selected.

## Encoding drop-down list box

Selects the encoding when you save a new file.
...
## Add a sequential number to the untitled document name checkbox
...
Specifies a template file name to load as a new file.
